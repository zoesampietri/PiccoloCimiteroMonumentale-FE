...
import { ServizipersonaliComponent } from './component/servizipersonali/servizipersonali.component';
...
export const routes: Routes = [
  ...
  { path: 'servizipersonali', component: ServizipersonaliComponent, canActivate: [authGuard] }
];
